  ...
  public class DoubleMount {
    ...
    public class Comp2025Mount {
      ...
      */
      ...
      private static final Transform3d FR_MODULE_TO_CAMERA = new Transform3d(
        new Translation3d(
      ...
      public static final VisionIOConstants[] IO_CONSTANTS = {
        new VisionIOConstantsPhotonVision(CAMERA_0_NAME, ROBOT_TO_FR_MODULE.plus(FR_MODULE_TO_CAMERA)),
      };
    }
